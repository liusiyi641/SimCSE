...
class GLMModel(GLMPreTrainedModel):
    ...
    def get_input_embeddings(self):
        new_word_embeddings = torch.nn.Embedding(
            ...
            max_norm=self.word_embeddings.max_norm,
            norm_type=self.word_embeddings.norm_type,
            scale_grad_by_freq=self.word_embeddings.scale_grad_by_freq,
            sparse=self.word_embeddings.sparse,
        )
        new_word_embeddings.weight=self.word_embeddings.weight
